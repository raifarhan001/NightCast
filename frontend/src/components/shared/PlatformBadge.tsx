...
export default function PlatformBadge({ item, className = "" }: PlatformBadgeProps) {
  ...
  switch (platform) {
    case "netflix":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#E50914]/25 backdrop-blur-xl border border-[#E50914]/50 flex items-center gap-1 shadow-[0_4px_12px_rgba(229,9,20,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
          <span className="font-black text-[11px] sm:text-xs text-[#FF2E3B] font-display leading-none drop-shadow-[0_0_8px_rgba(229,9,20,0.9)]">
            N
          </span>
        </div>
      );
    ...
    case "prime":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#00A8E1]/20 backdrop-blur-xl border border-[#00A8E1]/50 flex items-center gap-0.5 shadow-[0_4px_12px_rgba(0,168,225,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
          <span className="font-extrabold text-[9px] sm:text-[10px] text-[#00D2FF] lowercase leading-none font-sans tracking-wide">
            prime
          </span>
        </div>
      );
    ...
    case "disney":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#00D2FF]/20 backdrop-blur-xl border border-[#00D2FF]/50 flex items-center gap-0.5 shadow-[0_4px_12px_rgba(0,210,255,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
          <span className="font-extrabold text-[9px] sm:text-[10px] text-[#00E5FF] italic font-serif leading-none">
            Disney+
          </span>
        </div>
      );
    ...
    case "appletv":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-white/20 backdrop-blur-xl border border-white/40 flex items-center gap-1 shadow-[0_4px_12px_rgba(255,255,255,0.2),inset_0_1px_0_0_rgba(255,255,255,0.4)] text-white ${className}`}>
          ...
          <span className="font-extrabold text-[8px] sm:text-[9px] leading-none tracking-tight">tv+</span>
        </div>
      );

    case "hbo":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#9945FF]/25 backdrop-blur-xl border border-[#9945FF]/50 flex items-center gap-0.5 shadow-[0_4px_12px_rgba(153,69,255,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
          <span className="font-black text-[9px] sm:text-[10px] text-white font-sans leading-none tracking-wider">
            MAX
          </span>
        </div>
      );
    ...
    case "hulu":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#1CE783]/20 backdrop-blur-xl border border-[#1CE783]/50 flex items-center gap-0.5 shadow-[0_4px_12px_rgba(28,231,131,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
    ...
    case "paramount":
      return (
        <div className={`px-2 py-0.5 rounded-md bg-[#0064FF]/25 backdrop-blur-xl border border-[#0064FF]/50 flex items-center gap-0.5 shadow-[0_4px_12px_rgba(0,100,255,0.3),inset_0_1px_0_0_rgba(255,255,255,0.3)] ${className}`}>
          <span className="font-extrabold text-[9px] sm:text-[10px] text-[#3385FF] leading-none">
            Paramount+
          </span>
        </div>
      );
